...
/**
 * Created by pisarenko on 18.05.2017.
 */
/* ===========================================================
 ...
 */
public class SpiderWebPlot2 extends Plot implements Cloneable, Serializable {
     ...
     */
    public SpiderWebPlot2(CategoryDataset dataset) {
     ...
     */
    public SpiderWebPlot2(CategoryDataset dataset, TableOrder extract) {
        super();
        if (extract == null) {
    ...
    private void drawTicks(Graphics2D g2, Rectangle2D radarArea, double axisAngle, int cat) {
        double[] ticks = {0.15d, 0.3d, 0.45d, 0.6d, 0.75};
        String[] tickLabels = {"MO", "TU", "WE", "TH", "FR"};
        for (int i = 0; i < ticks.length; i++) {
            ...
            g2.rotate(-angrad);
            g2.translate(-xt, -yt);
            drawTickLabel(g2, radarArea, middlePoint, axisAngle, cat, tick, tickLabels[i]);
        }
    }
...
//        g2.drawRect((int) labelX, (int) labelY - labelH, labelW, labelH); // test rectangle
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SpiderWebPlot2)) {
            return false;
        }
        if (!super.equals(obj)) {
            return false;
        }
        SpiderWebPlot2 that = (SpiderWebPlot2) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        SpiderWebPlot2 clone = (SpiderWebPlot2) super.clone();
