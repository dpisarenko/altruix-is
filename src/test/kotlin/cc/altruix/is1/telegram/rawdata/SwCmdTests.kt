...
class SwCmdTests {
    ...
    fun executeSunnyDay() {
        ...
        val sut = Mockito.spy(SwCmd(af, tu))
        val text = "text"
    ...
    @Test
    fun nameAndHelp() {
        val sut = SwCmd(mock<IAutomatonFactory>())
        Assertions.assertThat(sut.name()).isEqualTo(SwCmd.Name)
        Assertions.assertThat(sut.helpText()).isEqualTo(SwCmd.Help)
    }
}