...
class RdCmdTests {
    ...
    fun executeSunnyDay() {
        ...
        val sut = Mockito.spy(RdCmd(af, tu))
        val text = "text"
    ...
    @Test
    fun nameAndHelp() {
        val sut = RdCmd(mock<IAutomatonFactory>())
        Assertions.assertThat(sut.name()).isEqualTo(RdCmd.Name)
        Assertions.assertThat(sut.helpText()).isEqualTo(RdCmd.Help)
    }
}