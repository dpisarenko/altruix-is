...
class EsCmdTests {
    ...
    fun executeSunnyDay() {
        ...
        val sut = Mockito.spy(EsCmd(af, tu))
        val text = "text"
    ...
    @Test
    fun nameAndHelp() {
        val sut = EsCmd(mock<IAutomatonFactory>())
        assertThat(sut.name()).isEqualTo(EsCmd.Name)
        assertThat(sut.helpText()).isEqualTo(EsCmd.Help)
    }
}