...
class EdfCmdTests {
    ...
    fun executeSunnyDay() {
        ...
        val sut = Mockito.spy(EdfCmd(af, tu))
        val text = "text"
    ...
    @Test
    fun nameAndHelp() {
        val sut = EdfCmd(mock<IAutomatonFactory>())
        Assertions.assertThat(sut.name()).isEqualTo(EdfCmd.Name)
        Assertions.assertThat(sut.helpText()).isEqualTo(EdfCmd.Help)
    }
}