...
class BbCmdTests {
    ...
    fun executeSunnyDay() {
        ...
        val sut = Mockito.spy(BbCmd(af, tu))
        val text = "text"
    ...
    @Test
    fun nameAndHelp() {
        val sut = BbCmd(mock<IAutomatonFactory>())
        Assertions.assertThat(sut.name()).isEqualTo(BbCmd.Name)
        Assertions.assertThat(sut.helpText()).isEqualTo(BbCmd.Help)
    }
}