...
class VocCmdTests {
    ...
    fun executeSunnyDay() {
        ...
        val sut = Mockito.spy(VocCmd(af, tu))
        val text = "text"
    ...
    @Test
    fun nameAndHelp() {
        val sut = VocCmd(mock<IAutomatonFactory>())
        assertThat(sut.name()).isEqualTo(VocCmd.Name)
        assertThat(sut.helpText()).isEqualTo(VocCmd.Help)
    }
}